    ...
    return(
        <>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:w-[190vh]  sm:p-8 lg:pr-30 lg:ml-20 gap-6 lg:gap-10">
                ...
                <div className="w-[80%] mt-[5vh] lg:mt-[4vh] pt-6 lg:h-[85vh]  lg:w-auto rounded-[15px] bg-[#212121] pr-6 lg:pr-10 pb-6 pl-6 lg:pl-10 ">
                    <div className="rounded-[15px]  bg-[#5c5c5c3f] m-[10 p-4 lg:m-[0] lg:p-10">
                        <img src={pfp} alt="profile picure" className='w-full h-auto  max-w-48 mx-auto lg:mx-0 p-0 m-0 lg:rounded-[1vh] rounded-[1vh] '/>
                    </div>
                    ...
                    <div className="mt-5 mb-6 lg:mb-10 p-2 text-center rounded-[5px] bg-[#5c5c5c3f]">
                    ...
                    <section>
                        <div className="grid grid-cols-1 gap-y-4 lg:gap-y-6 pt-4 lg:pt-[3vh]">
                            {infoItems.map((item, index) => (
                                <div key={index} className="flex items-center pt-2 lg:pt-[1vh]">
                                    <div className="p-2 lg:p-3 rounded-[10px] bg-[#5c5c5c3f]">
                ...
                <div className='w-[80%] lg:h-[85vh] lg:mt-[4vh] bg-[#212121] rounded-[15px]  lg:w-full lg:max-w-360  overflow-hidden overflow-y-scroll [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]' >
                    
                    {/* RESPONSIVE: center nav on mobile, right-aligned on lg+ */}
                    <ul className='flex gap-3 sm:gap-5 lg:justify-center lg:ml-265 pt-10 lg:pt-10 px-[8vh] lg:px-0 font-bold text-lg sm:text-xl lg:text-2xl '>
